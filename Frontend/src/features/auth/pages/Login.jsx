            ...
            >
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center min-h-screen px-6 sm:px-12 py-12 bg-white relative">
                    ...
                    <motion.div 
                        ...
                        className="w-full max-w-[340px] border border-black/15 p-6 sm:p-8 relative bg-white"
                    >
                        {/* Title Header */}
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4.5">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-transparent border border-black/15 px-3 py-2.5 text-xs font-semibold text-black outline-none transition-all duration-300 focus:border-black focus:ring-1 focus:ring-black"
                                    style={{ fontFamily: "'Outfit', sans-serif" }}
                                />
                            </div>
                            ...
                            <div className="flex flex-col gap-1.5">
                                <div className="flex items-center justify-between">
                                    ...
                                    <a 
                                        href="#"
                                        className="text-[9px] font-bold tracking-wider text-black/45 hover:text-black hover:underline underline-offset-4 transition-colors duration-200"
                                    >
                                        Forgot Password?
                                    </a>
                                </div>
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full border border-black bg-black hover:bg-white text-white hover:text-black font-black uppercase tracking-[0.25em] text-[10px] py-3.5 mt-1.5 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer disabled:bg-zinc-800 disabled:border-zinc-800 disabled:text-zinc-500 disabled:cursor-not-allowed"
                                style={{ fontFamily: "'Outfit', sans-serif" }}
                            >
                                {loading ? (
                                    <>
